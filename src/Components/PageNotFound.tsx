...
const PageNotFound = () => {
  return (
    <div className=" p-5 shadow-md  rounded-lg sm:p-10 relative flex flex-col max-w-xl mx-auto items-top justify-center min-h-[400px] bg-white sm:pt-0 dark:dark:bg-zinc-900 dark:text-white">
      <h1 className="text-3xl sm:text-4xl mb-4 ">Page <span className="text-sky-400 font-bold">Not  </span>Found <span className="text-sky-400 font-bold" >404</span></h1>
      ...
      <h1>Go To The <NavLink to="/" className="underline text-sky-400  rounded-sm font-medium  ms-1">HomePage </NavLink></h1>
    </div>
  )
}
